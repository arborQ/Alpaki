...
namespace Alpaki.TimeSheet.Database.Migrations
{
    ...
    [Migration("20210114112559_TimeSheetEventKeyMigration")]
    partial class TimeSheetEventKeyMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alpaki.TimeSheet.Database.Models.DomainEvent<Alpaki.TimeSheet.Database.Models.TimeSheetEventData, Alpaki.TimeSheet.Database.Models.TimeSheetEventType>", b =>
                {
                    ...
                    b.Property<int?>("TimeSheetPeriodMonth")
                        .HasColumnType("int");

                    b.Property<long?>("TimeSheetPeriodUserId")
                        .HasColumnType("bigint");

                    b.Property<int?>("TimeSheetPeriodYear")
                        .HasColumnType("int");

                    b.HasKey("EventId");

                    b.HasIndex("TimeSheetPeriodYear", "TimeSheetPeriodMonth", "TimeSheetPeriodUserId");

                    b.ToTable("PeriodDomainEvents","TimeSheet");
                });
            ...
            modelBuilder.Entity("Alpaki.TimeSheet.Database.Models.DomainEvent<Alpaki.TimeSheet.Database.Models.TimeSheetEventData, Alpaki.TimeSheet.Database.Models.TimeSheetEventType>", b =>
                {
                    b.HasOne("Alpaki.TimeSheet.Database.Models.TimeSheetPeriod", null)
                        .WithMany("DomainEvents")
                        .HasForeignKey("TimeSheetPeriodYear", "TimeSheetPeriodMonth", "TimeSheetPeriodUserId");
                });
