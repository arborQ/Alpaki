...
namespace Alpaki.Database.Migrations
{
    ...
    [Migration("20200820184203_AddMoreFieldsToSponsors")]
    partial class AddMoreFieldsToSponsors
    {
            ...
            modelBuilder.Entity("Alpaki.Database.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "admin",
                            LastName = "admin",
                            PasswordHash = "AQAAAAEAACcQAAAAECr/OIe5ZOWc1QneV/VOAb0QmYk9XFr5njO6yZF6zLusZbS5XGK43ZbYWqy/MX1B/A==",
                            Role = 7
                        });
                });
