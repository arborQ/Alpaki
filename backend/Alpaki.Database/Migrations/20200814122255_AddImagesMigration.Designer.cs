...
namespace Alpaki.Database.Migrations
{
    ...
    [Migration("20200814122255_AddImagesMigration")]
    partial class AddImagesMigration
    {
            ...
            modelBuilder.Entity("Alpaki.Database.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "admin",
                            LastName = "admin",
                            PasswordHash = "AMWDNSgUSar3xmOSVt0hh09gUP1a/ZN2D9uPyY4EjIj1WPg7pifby+Ze2s8dagC0Tw==",
                            Role = 7
                        });
                });
